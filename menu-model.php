...
if (is_home() || (single_cat_title("", false)!='' && !strpos(single_cat_title("", false),'deos'))) {
	...
	echo "<span style='color: #FFFFFF; line-height: 22px; padding: 0 15px 0 22px; float: left; font-size: 11px;'>Produtos em Destaque:</span>
	...
	echo "<li style='color:#fff' ><a href='https://novoactros-mercedesbenz.com.br/' target='_blank'>Novo Actros</a></li></ul>";
	?>
